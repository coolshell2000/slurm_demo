...
<p align="center">
  <img src="./2026-01-18_22-31.png" width="45%" />
  <img src="./2026-01-18_22-38.png" width="45%" />
</p>
...
In addition to Grafana/Prometheus, this project includes a lightweight, real-time **Slurm Admin Console** built with Flask.

- **URL**: [http://localhost:5000](http://localhost:5000)
- **Features**: Multi-language support (EN, ZH, DE, NL), time-series charts for job history, and storage monitoring.
- **How to run**:
  ```bash
  python3 app.py
  ```
